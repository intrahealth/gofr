...
* base[0] = #Basic
* type = #reference
* expression = "Basic.extension('http://gofr.org/fhir/StructureDefinition/owner').extension('userID')"
* xpath = "f:Basic/f:extension[@url='http://gofr.org/fhir/StructureDefinition/owner']/f:extension[@url='userID']"
* target[0] = #Person
...
* base[0] = #Basic
* type = #string
* expression = "Basic.extension('http://gofr.org/fhir/StructureDefinition/pairowner').extension('dhis2orgid')"
* xpath = "f:Basic/f:extension[@url='http://gofr.org/fhir/StructureDefinition/pairowner']/f:extension[@url='dhis2OrgId']"
...
* base[0] = #Basic
* type = #number
* expression = "Basic.extension('http://gofr.org/fhir/StructureDefinition/partitionID')"
* xpath = "f:Basic/f:extension[@url='http://gofr.org/fhir/StructureDefinition/partitionID']"
...
* base[0] = #Basic
* type = #reference
* expression = "Basic.extension('http://gofr.org/fhir/StructureDefinition/shared').extension('http://gofr.org/fhir/StructureDefinition/shareduser').extension('user')"
* xpath = "f:Basic/f:extension[@url='http://gofr.org/fhir/StructureDefinition/shared']/f:extension[@url='http://gofr.org/fhir/StructureDefinition/shareduser']/f:extension[@url='user']"
* target[0] = #Person
...
* base[0] = #Basic
* type = #token
* expression = "Basic.extension('http://gofr.org/fhir/StructureDefinition/shared').extension('shareToSameOrgid')"
* xpath = "f:Basic/f:extension[@url='http://gofr.org/fhir/StructureDefinition/shared']/f:extension[@url='shareToSameOrgid']"
...
* base[0] = #Basic
* type = #token
* expression = "Basic.extension('http://gofr.org/fhir/StructureDefinition/shared').extension('http://gofr.org/fhir/StructureDefinition/shareToAll').extension('activated')"
* xpath = "f:Basic/f:extension[@url='http://gofr.org/fhir/StructureDefinition/shared']/f:extension[@url='http://gofr.org/fhir/StructureDefinition/shareToAll']/f:extension[@url='activated']"
...
* base[0] = #Basic
* type = #reference
* expression = "Basic.extension('http://gofr.org/fhir/StructureDefinition/shared').extension('activeUsers')"
* xpath = "f:Basic/f:extension[@url='http://gofr.org/fhir/StructureDefinition/shared']/f:extension[@url='activeUsers']"
* target[0] = #Person