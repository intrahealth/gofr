...
Instance:       gofr-role-public
InstanceOf:     GofrRole
Title:          "GOFR Public Role"
Usage:          #example
* code = GofrResourceCodeSystem#role
* extension[role].extension[name].valueString = "Public"
* extension[role].extension[primary].valueBoolean = true
* extension[role].extension[task][0].valueReference = Reference(Basic/gofr-task-get-data-source)
* extension[role].extension[task][1].valueReference = Reference(Basic/gofr-task-get-source-pair)
* extension[role].extension[task][2].valueReference = Reference(Basic/gofr-task-view-home-page)
* extension[role].extension[task][3].valueReference = Reference(Basic/gofr-task-view-request-add-facility-page)
* extension[role].extension[task][4].valueReference = Reference(Basic/gofr-task-view-request-update-facility-page)
...
* extension[role].extension[task][9].valueReference = Reference(Basic/gofr-task-get-source-pair)
* extension[role].extension[task][10].valueReference = Reference(Basic/gofr-task-deactivate-source-pair)
* extension[role].extension[task][11].valueReference = Reference(Basic/gofr-task-activate-source-pair)
* extension[role].extension[task][12].valueReference = Reference(Basic/gofr-task-share-source-pair)
* extension[role].extension[task][13].valueReference = Reference(Basic/gofr-task-create-source-pair)
* extension[role].extension[task][14].valueReference = Reference(Basic/gofr-task-share-data-source)
* extension[role].extension[task][15].valueReference = Reference(Basic/gofr-task-view-data-source)
* extension[role].extension[task][16].valueReference = Reference(Basic/gofr-task-add-data-source)
* extension[role].extension[task][17].valueReference = Reference(Basic/gofr-task-get-data-source)
* extension[role].extension[task][18].valueReference = Reference(Basic/gofr-task-view-add-facility-requests)
* extension[role].extension[task][19].valueReference = Reference(Basic/gofr-task-view-update-facility-requests)
* extension[role].extension[task][20].valueReference = Reference(Basic/gofr-task-process-update-facility-request)
* extension[role].extension[task][21].valueReference = Reference(Basic/gofr-task-process-add-facility-request)
* extension[role].extension[task][22].valueReference = Reference(Basic/gofr-task-view-add-healthcare-service-page)
* extension[role].extension[task][23].valueReference = Reference(Basic/gofr-task-view-add-jurisdiction-page)
* extension[role].extension[task][24].valueReference = Reference(Basic/gofr-task-view-add-facility-page)
* extension[role].extension[task][25].valueReference = Reference(Basic/gofr-task-view-add-organization-page)
* extension[role].extension[task][26].valueReference = Reference(Basic/gofr-task-view-config-page)
* extension[role].extension[task][27].valueReference = Reference(Basic/gofr-task-view-home-page)
* extension[role].extension[task][28].valueReference = Reference(Basic/gofr-task-view-search-facility-page)
* extension[role].extension[task][29].valueReference = Reference(Basic/gofr-task-view-search-jurisdiction-page)
* extension[role].extension[task][30].valueReference = Reference(Basic/gofr-task-view-search-service-page)
* extension[role].extension[task][31].valueReference = Reference(Basic/gofr-task-view-search-organization-page)
* extension[role].extension[task][32].valueReference = Reference(Basic/gofr-task-write-questionnaireresponse-resource)
* extension[role].extension[task][33].valueReference = Reference(Basic/gofr-task-read-questionnaire-resource)
* extension[role].extension[task][34].valueReference = Reference(Basic/gofr-task-read-location-resource)
* extension[role].extension[task][35].valueReference = Reference(Basic/gofr-task-read-organization-resource)
* extension[role].extension[task][36].valueReference = Reference(Basic/gofr-task-read-metadata-resource)
* extension[role].extension[task][37].valueReference = Reference(Basic/gofr-task-read-healthcareservice-resource)
* extension[role].extension[task][38].valueReference = Reference(Basic/gofr-task-read-document-reference)
* extension[role].extension[task][39].valueReference = Reference(Basic/gofr-task-read-value-set)
* extension[role].extension[task][40].valueReference = Reference(Basic/gofr-task-read-code-system)
* extension[role].extension[task][41].valueReference = Reference(Basic/gofr-task-read-structure-definition)
* extension[role].extension[task][42].valueReference = Reference(Basic/gofr-task-close-matching)
* extension[role].extension[task][43].valueReference = Reference(Basic/gofr-task-open-matching)
* extension[role].extension[task][44].valueReference = Reference(Basic/gofr-task-manage-data-source)
* extension[role].extension[task][45].valueReference = Reference(Basic/gofr-task-access-facility-reconciliation-mod)