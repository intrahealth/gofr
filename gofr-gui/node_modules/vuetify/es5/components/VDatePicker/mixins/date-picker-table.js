...
/* @vue/component */
  ...
  methods: {
    ...
    isValidScroll: function isValidScroll(value, calculateTableDate) {
      ...
      return value === 0 || value < 0 && (this.min ? tableDate >= (0, _util.sanitizeDateString)(this.min, sanitizeType) : true) || value > 0 && (this.max ? tableDate <= (0, _util.sanitizeDateString)(this.max, sanitizeType) : true);
    },
